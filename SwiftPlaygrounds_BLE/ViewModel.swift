...
class ViewModel: ObservableObject {
    ...
    @Published var right_front_leg_ini:Double = 90
    @Published var right_hind_leg_ini:Double = 90
    @Published var left_front_leg_ini:Double = 90
    @Published var left_hind_leg_ini:Double = 90
    ...
    func checkCommand(cmd: String) {
        ...
        if arr.count == 2 {
            if arr[0] == "ri" {
                ...
                if para.count == 4 {
                    self.right_front_leg_ini = 180 - Double(para[0])!
                    self.right_hind_leg_ini = Double(para[1])!
                    self.left_front_leg_ini = 180 - Double(para[2])!
                    self.left_hind_leg_ini = Double(para[3])!
                }
            }
        }
    ...
    func setAnglesInit() {
        ...
        var cmd: String = "si "
        cmd += String(Int(self.right_front_leg_ini) )
        cmd += "," + String(Int(self.right_hind_leg_ini) )
        cmd += "," + String(Int(self.left_front_leg_ini) )
        cmd += "," + String(Int(self.left_hind_leg_ini) )
